...
<body>
    ...
    <div class="modal-box">
        ...
        <p class="py-4">Você tem certeza que deseja excluir essa postagem?</p>
        <a class="btn btn-error">Confirmar</a>
    </div>
    </dialog>
                        ...
                        <?php if (isset($_SESSION["usuario"])):?>
                            <?php if ($row["email"] === $_SESSION["email"]): ?>
                                <div class="float-right">
                                    ...
                                    <?php echo '<a class="btn btn-error" onclick="onDeletePost(confirm_delete_modal, ' . $row["id"] . ')">' ?>
